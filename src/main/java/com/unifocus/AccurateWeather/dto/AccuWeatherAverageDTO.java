...
public class AccuWeatherAverageDTO implements Serializable {
	...
	public AccuWeatherAverageDTO(LocalDate date, LocalDate datum, BigDecimal daily, BigDecimal nightly, BigDecimal pressure, BigDecimal totalDaily, Integer quantDaily, BigDecimal totalNightly, Integer quantNightly, BigDecimal totalPressure, Integer quantPressure) {
		this.date = date;
		this.datum = datum;
		this.daily = daily;
	...
	public void plusMap(AccuWeatherMapTimeDTO map) {
		if (map.isDaily()) {
	...
	public String toString() {
		return "AccuWeatherAverageDTO [date=" + date + ", datum=" + datum + ", daily=" + daily + ", nightly=" + nightly
				+ ", pressure=" + pressure + "]";
	}
